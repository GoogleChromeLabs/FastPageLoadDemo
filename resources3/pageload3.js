...
//alert for not-real links
function narl() {
    alert("We told you, that's not a real link.");
}

/*
Table sorting script  by Joost de Valk, http://www.joostdevalk.nl/code/sortable-table/
...
//var image_path = "";
//var image_up = "arrow-none.gif";
//var image_down = "arrow-none.gif";
...
function ts_makeSortable(t) {
    ...
    for (var i = 0; i < firstRow.cells.length; i++) {
        ...
        if (cell.className != "unsortable" && cell.className.indexOf("unsortable") == -1) {
            // *** dag FOLLOWING COMMENTED LINE AND NEW LINE BELOW ELIMINATES ARROW GRAPHICS ***
            //			cell.innerHTML = '<a href="#" class="sortheader" onclick="ts_resortTable(this, '+i+');return false;">'+txt+'<span class="sortarrow">&nbsp;&nbsp;<img src="'+ image_path + image_none + '" alt="&darr;"/></span></a>';
            cell.innerHTML = '<a href="#" class="reg title" onclick="ts_resortTable(this, ' + i + ');return false;">' + txt + '</a>';
        }
    }
    // *** dag COMMENT OUT FOLLOWING IF TO ELIMINATE ALTERNATING ROW COLORS ***
...
function ts_resortTable(lnk, clid) {
    ...
    newRows.sort(sortfn);
    // *** dag FOLLOWING IF/ELSE COMMENTED OUT TO DISABLE DESCENDING SORT ***
    /*
    ...
    */
    ...
    // *** dag COMMENTED OUT DUE TO ABOVE COMMENT-OUT ***
...
// *** dag COMMENT OUT ENTIRE FUNCTION TO ELIMINATE ALTERNATE ROW COLORS ***
